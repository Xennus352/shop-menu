      ...
      <div className="container mx-auto max-w-5xl px-4 py-6 relative z-10">
        ...
        <div className="flex gap-2 mb-8 overflow-x-auto pb-2 scrollbar-hide">
          <button
            ...
            style={{
              background: selectedCategory === "all" ? colors.olive : "white",
              color: selectedCategory === "all" ? "white" : colors.textDark,
              borderColor:
                selectedCategory === "all" ? colors.olive : `${colors.olive}20`,
            }}
          >
          ...
          {categories.map((cat) => (
            <button
              ...
              style={{
                ...
                color: selectedCategory === cat.id ? "white" : colors.textDark,
                borderColor:
